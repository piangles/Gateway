...
import com.TBD.app.gateway.handling.requests.RequestRouter;
import com.TBD.app.gateway.handling.requests.ResponseProcessor;
...
public final class ClientHandler
{
	...
	public ClientHandler(InetSocketAddress remoteAddr, ClientEndpoint clientEndpoint)
	{
		...
		sessionMgmtService = BackboneServiceLocator.getInstance().getSessionManagementService();
		System.out.println("RECEIVED A NEW CONNECTION111111");
		logger = BackboneServiceLocator.getInstance().getLoggingService();
