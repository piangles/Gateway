...
public final class LoginResponse extends AuthenticationDetails
{
	...
	public LoginResponse(boolean mfaEnabled, boolean authenticatedByToken, boolean authenticatedBySession, boolean loggedInAsGuest, String userId, String sessionId, String phoneNo, long inactivityExpiryTimeInSeconds, long lastLoggedInTimestamp)
	{
		super(true, mfaEnabled, authenticatedByToken, authenticatedBySession, userId, sessionId, phoneNo, inactivityExpiryTimeInSeconds, lastLoggedInTimestamp);
